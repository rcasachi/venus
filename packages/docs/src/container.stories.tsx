...
import {  Box, Button, Container, Flex, Grid, Paragraph, Text, TextField } from "@venusui/components";
...
export const containerForm = () => (
  <>
    ...
    <Container size="4">
      <Text as="p" size="3" css={{ textAlign: 'center', backgroundColor: '$slate3', paddingTop: '$2', paddingBottom: '$2' }}>
        No max width
      </Text>
    </Container>
  </>
