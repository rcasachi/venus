...
import { Flex, Box, Heading, Avatar, Popover, PopoverTrigger, PopoverContent, Text, Link2Icon, AvatarGroup, AvatarNestedItem, Status } from "@venusui/components";
...
export const avatars = () => (
  <>
    ...
    <Avatar alt="John Smith" src="" fallback="J" css={{ marginBottom: '$6' }} />
      ...
      <Flex css={{ gap: '$3' }}>
        <button style={{ border: 'none', backgroundColor: 'transparent' }}>
          <Avatar
            ...
            fallback="J"
          />
          <Text size="1" css={{ display: 'block', marginTop: '$1' }}>
            colmtuite
          </Text>
        </button>
        <button style={{ border: 'none', backgroundColor: 'transparent' }}>
