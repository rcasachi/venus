...
import { Flex, Box, Table, Caption, Thead, Th, Td, Tr, Tbody, CheckIcon, Tfoot } from "@venusui/components";
        ...
        <Tr>
          ...
          <Td align="center">
            <Flex css={{ gap: '$1', justifyContent: 'flex-end' }}>
              <Box css={{ width: 15, height: 15, backgroundColor: '$green9', borderRadius: '$round' }}>
                <CheckIcon />
              </Box>
              <Box css={{ width: 15, height: 15, backgroundColor: '$green9', borderRadius: '$round' }}>
                <CheckIcon />
