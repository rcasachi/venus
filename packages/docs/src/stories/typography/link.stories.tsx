...
export default {
  ...
  argTypes: {
    variant: {
      options: ['blue', 'subtle', 'contrast', 'primary'],
      control: {
        type: 'inline-radio',
      },
    },
  ...
  render: () => (
    <>
      ...
      <Paragraph>
        ...
        Sorrow. A lot of startup stuff is focused on the initial phases, when
        you don’t have a team, idea, or investors.
      </Paragraph>
    </>
  ),
}
